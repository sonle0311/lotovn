        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left space-y-6">
          ...
          >
            <div className="relative z-30 py-4 px-2">
              ...
              <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-black tracking-tight leading-none text-white drop-shadow-[0_0_15px_rgba(234,179,8,0.5)] select-none mt-[-0.1em] relative z-10">
                VIỆT NAM
              </h1>
            ...
            <div className="bg-[#1a0505]/80 rounded-[22px] p-6 sm:p-8 space-y-6 border border-white/5 relative overflow-hidden group">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-yellow-500/80 ml-1">Định danh (Tên)</label>
                  <input
                    type="text"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-black uppercase tracking-widest text-yellow-500/80 ml-1">Mã Phòng</label>
                  <input
                    type="text"
              ...
              <div className="pt-2 flex flex-col gap-3">
                ...
                <button onClick={handleCreate} className="w-full py-3.5 bg-white/5 border border-white/10 rounded-xl text-yellow-500 font-bold text-base hover:bg-white/10 hover:border-yellow-500/50 transition-all flex items-center justify-center gap-2 group/btn2">
